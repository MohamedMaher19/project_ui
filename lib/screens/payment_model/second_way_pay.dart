...
class SecondPayScreen extends StatelessWidget {
  SecondPayScreen({Key? key}) : super(key: key);
                                    ...
                                    child: ListView(
                                      children:[
                                        ...
                                        children: [
                                          ...
                                          TextUtils(text: '**** **** ****  0817', fontSize: 15, fontWeight: FontWeight.bold, color: Colors.grey),
                                          Image.asset('assets/images/android-done-all-1.png' , ),
